...
func NewUserService(repo repository.UserRepository, EmailService service.EmailService, VerificationRepo repository.VerificationRepository) *UserService {
	return &UserService{UserRepo: repo, EmailService: EmailService, VerificationRepo: VerificationRepo}
}
...
// UpdateUser (CRUD - Update Logic) - WITHOUT email change
func (s *UserService) UpdateUser(id uint, username, bio string) (*model.UserModel, error) {
