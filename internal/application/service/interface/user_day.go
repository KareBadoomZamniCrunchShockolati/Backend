...
type UserDayServicer interface {
	...
	GetGoalProgressChart(userID, challengeID uint, start, end time.Time) (*dto.DaysProgressResponse, error)
	GetTotalFeelings(userID, challengeID uint) (*dto.FeelingCountResponse, error)
}